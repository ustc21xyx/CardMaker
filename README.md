...
3) 在各 tab 中编辑字段，或点字段旁「AI 生成」
4) 体量很大时建议先点右上「占位整卡」生成骨架（worldbook 先占位），再分批完善
4) 上传封面 PNG，点「导出 PNG」即可得到可导入 SillyTavern 的角色卡 PNG

## 大卡/世界书的增量写法

- `世界书` tab 支持「追加/覆盖」和「每批条数」，适合分批生成词条
- `对话增量` tab 可以直接和 AI 说“继续追加世界书 8 条/补充某条 content/改写开场白”等，自动应用到草稿
